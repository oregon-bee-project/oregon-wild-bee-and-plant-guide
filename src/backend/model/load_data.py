...
def load_data() -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    """
    file_path_labels = "src/data/b-team/plant-pollinators-OBA-2025-assigned-subset-labels.viz"
    file_path_taxa = "src/data/b-team/plant-pollinators-OBA-2025-assigned-taxa.viz"
